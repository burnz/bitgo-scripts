...
//const params = {address: "2N6WNRJzgwokT2qKLSCoYovBJqUmN5Ay8Dr", "changeAddresses": ["2MwR7f7TjPVrphbQ98Y3x8VKNNJbpe4WZHy"], amount: 200000, walletPassphrase: process.env.BITGO_PASSPHRASE, unspents: ["8c6da4a1d564b2479b7a6802bee35953e7336cf0b99a6cbe981914f4a00d7a42:0"]};
const params = {walletPassphrase: process.env.BITGO_PASSPHRASE, unspents: ["8c6da4a1d564b2479b7a6802bee35953e7336cf0b99a6cbe981914f4a00d7a42:0"]};
// const recipients = {};
...
bitgo.coin('tbtc').wallets().get({ id: walletId }).then(function(wallet) {
    wallet.sendMany({recipients: recipients, walletPassphrase: process.env.BITGO_PASSPHRASE, unspents: ["8c6da4a1d564b2479b7a6802bee35953e7336cf0b99a6cbe981914f4a00d7a42:0"]},
        function(err, result) {
